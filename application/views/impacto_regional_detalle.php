...
<div class="w-section st-impacto-regional">
	<div class="w-container">
        ...
        <a class="btn_atras" href="/impacto-regional">Regresar al mapa</a>
    </div>
        		...
        		<div class="w-col w-col-<?=$w_col?> <?=$w_col2?>">
        			<div class="boxcol">
        				<div class="tnumero bg1">
        					<span><?=number_format($total_cola,0,",",".")?></span>
        				</div>
        		...
        		<div class="w-col w-col-<?=$w_col?> <?=$w_col2?>">
        			<div class="boxcol">
        				<div class="tnumero bg3">
        					<span><?=number_format($total_sucu,0,",",".")?></span>
        				</div>
        				<p class="tdesc">
        					<?php if ($nid_copia == 5){
...
<?php require_once 'bloques/testimonios_impacto_regional.php';?>
			...
			<?php
				...
				foreach($otros_paises['results'] as $key => $value2){
					...
					if($nid==$nid_copia){
						...
						echo '<li><a href="/impacto-regional/'.$this->general->formatURL($title).'/'.$nid.'"><img src="'.$field_bandera.'" /></a></li>';
					}
				}
